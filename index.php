    ...
    <body ng-controller="PageController">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#">Elaboração de Contratos</a></li>
                ...
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Care your family">
                        ...
                        <div class="caption slider-title dark sft"
                            ...
                            Contratos <br>
                            <span class="colored-text">Fazemos</span>
                        </div>
        ...
        <div class="container">
            <div class="row center-title">
                <div class="col-md-8 col-md-offset-2 clearfix text-center wow animated fadeInUp">
                    <h2>ELABORAÇÃO E ANÁLISE DE CONTRATOS</h2>
                    <p>
                        Assessoria Jurídica
                    </p>
                    <!--                   -->
            ...
            <div class="text-center">
                <a href="#" class="btn btn-lg btn-theme-bg">Veja Nossos serviços <i class="pe-7s-right-arrow"></i></a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="center-title">
                            <i class="pe-7s-users"></i>
                            <h2>Conheça  nossa<strong>Equipe</strong></h2>
                            <p>
            ...
            <div class="container">
                <div class="row">
                    <!--div class="col-sm-6 margin30">
                        <h3>Veja o video sobre o nosso trabalho</h3>
        ...
        <section class="testimonials">
            <div class="container">
                <div class="center-title">
                    ...
                    <h2>O que nos <strong>Dissemos?</strong></h2>                        
                </div>
                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 text-center">
                        <h3>Precisa de acompanhamento ?</h3>
                    </div>
                    <div class="col-md-4 text-center">
                        <a href="#" class="btn btn-white-border btn-lg">Faça um Orçamento</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="blog-home">
            <div class="container">
                <div class="center-title">
                    ...
                    <h2>Nossas ultimas  <strong>Noticias</strong></h2>                        
                </div>
                <div class="row">
                    <div class="col-md-4 margin30">
                        <div class="blog-post">
                            ...
                            <span>Julho 21, 2015 por Talyta</span>
                            <p>
                    ...
                    <div class="col-md-4 margin30">
                        <div class="blog-post">
                            ...
                            <span>Julho21, 2015 por Talyta</span>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras id bibendum massa, vulputate consectetur dui. Ut ut eros congue, condimentum massa
                            </p>
                            <p><a href="#">Read more...</a></p>
        ...
        <div class="cta-newsletter">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text-center">
                        <h3>Se inscreva em nosso mailing</h3>
                        <p>Se inscreva e saiba de todas as nossas ultimas atualizações</p>
                        <form class="form-inline assan-newsletter">
                            <div class="form-group">
                                <input type="text" name="email" class="form-control" id="email" placeholder="seu email">
                            </div>
                            <button type="submit" name="submit" class="btn btn-theme-bg btn-lg">Inscrever</button>
                        </form>
                    </div>
                </div>
            </div>
