...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <!-- Le styles -->
    <link href="ecom/bootstrap/css/bootstrap.css" rel="stylesheet">
    <link id="switch_style" href="ecom/bootstrap/css/united/bootstrap.css" rel="stylesheet">
    <link href="ecom/css/main.css" rel="stylesheet">
    <link href="ecom/css/jquery.rating.css" rel="stylesheet">
...
<div class="span3 product_list">
	<ul class="nav">
		...
		<img src="ecom/css/images/carousel_1.jpg" alt="">
              ...
              <div class="item">
                <img src="ecom/css/images/carousel_2.jpg" alt="">
                <div class="carousel-caption">
              ...
              <div class="item">
		<img src="ecom/css/images/carousel_3.jpg" alt="">
                <div class="carousel-caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="ecom/css/images/ps-vita-150cx123.jpg" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="ecom/css/images/nexus-one-3-150x123.jpg" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="ecom/css/images/thumb_sam_3d.jpg" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="ecom/css/images/ipad_case.jpg" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="ecom/css/images/HMX-H104.JPG" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="ecom/css/images/expic.png" /></a>
            <div class="caption">
    ...
    <button type="submit" class="btn pull-right">Subscribe</button>
            ...
            <a href="#"><img alt="" title="" src="ecom/css/images/paypal_mc_visa_amex_disc_150x139.gif" /></a>
			<a href="#"><img alt="" src="ecom/css/images/bnr_nowAccepting_150x60.gif" /></a>
...
<script src="ecom/bootstrap/js/bootstrap.js"></script>
<script src="ecom/js/jquery.rating.pack.js"></script>
<script>
$(function() {
