                ...
                <div class="col">
                    ...
                    <div class="signup">
                        <form id="form_cadastro">
                            <fieldset>
                                <legend>Recuperar a minha a senha</legend>
                                ...
                                <div class="form-group mb-2">
                                    <button type="button" class="btn btn-primary" id="recuperar">Recuperar</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            $("#recuperar").on('click', function(){
                ...
                $.post('betlolo/lembrar', dados,function( data ) {
                 // window.location = "/betlolo/"+data;
                 alert("Enviamos a senha "+data+ " para o email "+$("#email").val()+"em producao trocar" );
                });
