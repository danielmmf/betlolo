...
<body>
  ...
  <header class="page-header">
    ...
    <div class="rd-navbar-wrap">
      <nav class="rd-navbar rd-navbar_corporate" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-sm-device-layout="rd-navbar-fixed"
        ...
        data-stick-up-clone="false" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true" data-xl-stick-up="true"
        data-xxl-stick-up="true" data-md-stick-up-offset="60px" data-lg-stick-up-offset="145px" data-xl-stick-up-offset="145px"
        data-xxl-stick-up-offset="145px" data-body-class="rd-navbar-corporate-linked">
        <!-- RD Navbar Panel-->
        <div class="rd-navbar-panel">
          ...
          <div class="rd-navbar-brand rd-navbar-static--hidden">
            <a class="brand-name" href="index.html">
              <img src="images/logo-174x32.png" alt="" width="174" height="32" />
            </a>
          </div>
        </div>
        <!-- RD Navbar Top Panel-->
                  ...
                  <ul class="rd-navbar-items-list">
                    ...
                    <li>
                      <ul class="list-inline-xxs">
                        ...
                        <li>
                          <a class="icon icon-xxs icon-primary fa fa-google-plus" href="#"></a>
                        </li>
                        <li>
                          <a class="icon icon-xxs icon-primary fa fa-vimeo" href="#"></a>
                        </li>
                        <li>
                          <a class="icon icon-xxs icon-primary fa fa-youtube" href="#"></a>
                        </li>
                        <li>
                          <a class="icon icon-xxs icon-primary fa fa-pinterest-p" href="#"></a>
                        </li>
                      </ul>
                    </li>
                  </ul>
                ...
                <div class="rd-navbar-nav-wrap rd-navbar-search_not-collapsable">
                  <ul class="rd-navbar-items-list rd-navbar-search_collapsable">
                    ...
                    <li class="rd-navbar-nav-wrap__shop">
                      <a class="icon icon-md linear-icon-cart link-gray-4" href="cart.html"></a>
                    </li>
                  </ul>
                  <!-- RD Search-->
  ...
  <!-- Swiper-->
  <section>
    <div class="swiper-container swiper-slider swiper-slider_fullheight" data-simulate-touch="false" data-interval="3000" data-loop="false"
      data-autoplay="false">
      <div class="swiper-wrapper">

        <div class="swiper-slide bg-gray-dark" data-slide-bg="images/slider-slide-3-1920x980.jpg" data-interval="3000">
          <div class="swiper-slide-caption text-center">
            <div class="container">
              <h1 data-caption-animate="fadeInUpSmall">
                <span>Futuro Financeiro</span>
              </h1>
              <h3 data-caption-animate="fadeInUpSmall" data-caption-delay="200">Planeje suas finanças</h3>
              <!--<div class="group-lg group-middle"><a class="button button-primary" data-caption-animate="fadeInUpSmall" data-caption-delay="350" href="#section-see-features" data-custom-scroll-to="section-see-features">See Features</a><a class="button button-gray-light-outline" data-caption-animate="fadeInUpSmall" data-caption-delay="350" href="//www.templatemonster.com/website-templates/monstroid2.html">Buy template</a></div>-->
            </div>
          </div>
        </div>

        <!--Slider 2-->
        <div class="swiper-slide bg-accent" data-slide-bg="images/slider-slide-2-1920x980.jpg" data-interval="30000000">
          <div class="swiper-slide-caption text-center">
            <div class="container">
              <h1 data-caption-animate="fadeInUpSmall">Você recebeu uma tranferência de R$ 5.000,00!</h1>
              <h3 data-caption-animate="fadeInUpSmall">Baseado em suas projeções futuras, recomendamos investir R$3.000,00</h3>
              <br>
              <h4>Clique para visualizar sugestões de investimentos rentáveis de acordo com seu perfil</h4>
            </div>
          </div>
        </div>
                    ...
                    <div class="vide_bg" data-vide-bg="video/video-lg" data-vide-options="posterType: jpg">
                      <div class="swiper-slide-caption text-center">
                        <div class="container">
                          ...
                          <div class="group-lg group-middle"><a class="button button-black" data-caption-animate="fadeInUpSmall" data-caption-delay="350" href="#section-see-features" data-custom-scroll-to="section-see-features">Take a tour</a><a class="button button-primary" data-caption-animate="fadeInUpSmall" data-caption-delay="350" href="//www.templatemonster.com/website-templates/monstroid2.html">Buy template</a></div>
                        </div>
                      </div>
                    </div>
            </div>-->
  ...
  <section class="section-xl bg-gray-lighter">
    <div class="container">
      <h3>Meu gráfico financeiro</h3>
      <!-- Grey with black text -->
      <nav class="navbar navbar-expand-sm bg-light navbar-light">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link" href="#">Anual</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Semestral</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Mensal</a>
          </li>
          <li class="nav-item">
            <a class="nav-link disabled" href="#">Diario</a>
          </li>
        </ul>
      </nav>
      <div class="row justify-content-md-center flex-lg-row-reverse align-items-lg-center justify-content-lg-between row-50">
        ...
        <div class="col-md-9 col-lg-6">
              ...
              <div class="unit flex-row unit-spacing-md">
                <div class="unit-left">
                  <div class="blurb-minimal__icon">
                    <span class="icon linear-icon-rocket"></span>
                  </div>
                </div>
                <div class="unit-body">
          ...
          <!--<article class="blurb blurb-minimal">
              <div class="unit flex-row unit-spacing-md">
                <div class="unit-left">
                  <div class="blurb-minimal__icon">
                    <span class="icon linear-icon-equalizer"></span>
                  </div>
                </div>
                <div class="unit-body">
          ...
          <div class="alert alert-danger">
            <strong>Dica:</strong> O banco original oferece limite de crédito. Clique e confira
          </div>
          <!-- Blurb minimal-->
          <article class="blurb blurb-minimal">
            <div class="unit flex-row unit-spacing-md">
              <div class="unit-left">
                <div class="blurb-minimal__icon">
                  <span class="icon linear-icon-arrow-down-square"></span>
                </div>
              </div>
              <div class="unit-body">
                <p class="blurb__title">Extrato
        ...
        <div class="col-md-7 col-lg-4">
          <!--<figure class="image-sizing-1">
              <img src="images/home-business-1-388x608.png" alt="" width="388" height="608" />
            </figure>-->
          <table class="table">
            <thead>
              <tr>
      ...
      <div class="alert alert-success">
        <strong>Dica:</strong> O banco original também oferece plano odontológico! clique para ver o estudo comparativo
      </div>
      <!--Adicionar a ocorrencia-->
      <!-- Button trigger modal -->
<center>
      <button type="button" class="btn btn-lg center text-center" data-toggle="modal" data-target="#myModal" style="background-color:transparent">
        <span class="fa fa-plus-circle center text-center"></span>
        <h4 class="center text-center">Agendar gastos</h4>
      </button>
      </center>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Agendar Gastos</h4>
            </div>
    ...
    <div class="container">
      <div class="row justify-content-lg-center">
        <div class="col-lg-10 col-xl-8">
          ...
          <p>Analise os gastos individuais de cada portador, e os gastos categorizados.</p>
        </div>
      </div>
      ...
      <div class="row justify-content-md-center row-50">
        <div class="col-md-6 col-lg-3">
          ...
          <div class="col-md-6 col-lg-3">
            ...
            <article class="box-counter">
              ...
              <p class="box-counter__title">Celular novo</p>
            </article>
          </div>
          <br>
          <article class="box-counter">
            ...
            <p class="box-counter__title">Reserva mensal</p>
          </article>
        </div>
        <div class="col-md-6 col-lg-3">
          <!-- Box counter-->
          <article class="box-counter">
            ...
            <p class="box-counter__title">Reserva atual</p>
          </article>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <article class="box-counter">
            ...
            <p class="box-counter__title">Tempo restante</p>
          </article>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-md-center align-items-lg-center justify-content-lg-between row-50">
        <div class="col-md-9 col-lg-5">
          <h3>Nosso trabalho é cuidar de você</h3>
          <p>Desde atendimento odontologico até seguro de celular , nossos serviços visam a sua segurança e a sua comodidade , todos os serviços ao alcance de um clique</p>
        </div>
        <div class="col-md-9 col-lg-6">
          <div class="row gallery-wrap">
            <div class="col-6">
              <figure>
                <img src="images/home-default-3-301x227.jpg" alt="" width="301" height="227" />
              </figure>
            </div>
            <div class="col-6">
              <figure>
                <img src="images/home-default-4-301x227.jpg" alt="" width="301" height="227" />
              </figure>
            </div>
            <div class="col-6">
              <figure>
                <img src="images/home-default-5-301x227.jpg" alt="" width="301" height="227" />
              </figure>
            </div>
            <div class="col-6">
              <figure>
                <img src="images/home-default-6-301x227.jpg" alt="" width="301" height="227" />
              </figure>
            </div>
          </div>
        </div>
          ...
          <div class="pricing-table-wrap">
            <div class="pricing-table">
              ...
              <div class="pricing-footer">
                <a class="button button-primary" href="#">Saber mais!</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="pricing-table pricing-table-label">
              ...
              <div class="pricing-body">
                <ul class="list">
                  ...
                  <li>Seguro de vida familiar</li>
                  <li>Plano de saude familiar enfermaria</li>
                  <li>Plano odontologico familiar</li>
                </ul>
              </div>
              <div class="pricing-footer">
                <a class="button button-primary" href="#">Saber Mais!</a>
            ...
            <div class="pricing-table">
              ...
              <div class="pricing-body">
                <ul class="list">
                  ...
                  <li>Seguro de vida premium</li>
                  <li>Plano de saude suite</li>
                  <li>Plano odontologico e estetico</li>
                </ul>
              </div>
              <div class="pricing-footer">
                <a class="button button-primary" href="#">Saber Mais!</a>
            ...
            <div class="pricing-table">
              ...
              <div class="pricing-body">
                <ul class="list">
                  ...
                  <li>Seguro de vida familiar premium</li>
                  <li>Plano de saude familiar suite</li>
                  <li>Plano odontologico e estetico</li>
                </ul>
              </div>
              <div class="pricing-footer">
    ...
    <div class="parallax-container bg-image rd-parallax-light" data-parallax-img="images/parallax-01.jpg">
      <div class="parallax-content">
        <div class="container section-xxl">
          <h2>Viu a vantangem</h2>
          <p>faça combos de promoçoes.</p>
          <a class="button button-primary" href="#">Saber Mais!</a>
        </div>
      </div>
    </div>
  ...
  <section class="section-xl bg-default text-center">
    <div class="container">
      <h3>Olha o que dizem sobre as vantagens</h3>
      <div class="row row-50">
        <div class="col-md-6 col-lg-4">
          ...
          <div class="quote-default quote-default_left-v2">
            ...
            <div class="quote-default__text">
              <p class="q">Since I’m not a real pro in web design, I love to use these ready-made and beautifully looking templates. They
                are available at very affordable prices and they save you a lot of time, and deliver from a lot of sweat
                and tears!</p>
            </div>
            <p class="quote-default__cite">Ze Gaiola</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <!-- Quote default-->
          <div class="quote-default quote-default_left-v2">
            ...
            <div class="quote-default__text">
              <p class="q">This template has everything I was looking for my business website to have. From easy-to-customize pages to
                flawlessly working web tools, Monstroid² is my number one choice!</p>
            </div>
            <p class="quote-default__cite">Pafuncio Giovanni</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <!-- Quote default-->
          <div class="quote-default quote-default_left-v2">
            <div class="quote-default__image">
              <img src="images/testimonials-3-120x120.jpg" alt="" width="120" height="120" />
            </div>
            <svg class="quote-default__mark" version="1.1" baseprofile="tiny" x="0px" y="0px" width="30.234px" height="23.484px" viewbox="0 0 30.234 23.484">
              <g>
                <path d="M12.129,0v1.723c-2.438,0.891-4.348,2.291-5.73,4.201c-1.383,1.911-2.074,3.897-2.074,5.959 c0,0.445,0.07,0.773,0.211,0.984c0.093,0.141,0.199,0.211,0.316,0.211c0.117,0,0.293-0.082,0.527-0.246 c0.75-0.539,1.699-0.809,2.848-0.809c1.336,0,2.519,0.545,3.551,1.635c1.031,1.09,1.547,2.385,1.547,3.885 c0,1.57-0.592,2.953-1.775,4.148c-1.184,1.195-2.619,1.793-4.307,1.793c-1.969,0-3.668-0.809-5.098-2.426 C0.715,19.441,0,17.274,0,14.555c0-3.164,0.972-6,2.918-8.508C4.863,3.539,7.933,1.524,12.129,0z M29.039,0v1.723 c-2.438,0.891-4.348,2.291-5.73,4.201c-1.383,1.911-2.074,3.897-2.074,5.959c0,0.445,0.07,0.773,0.211,0.984 c0.094,0.141,0.199,0.211,0.316,0.211s0.293-0.082,0.527-0.246c0.75-0.539,1.699-0.809,2.848-0.809c1.336,0,2.52,0.545,3.551,1.635 s1.547,2.385,1.547,3.885c0,1.57-0.592,2.953-1.775,4.148s-2.619,1.793-4.307,1.793c-1.969,0-3.668-0.809-5.098-2.426 s-2.145-3.785-2.145-6.504c0-3.164,0.973-6,2.918-8.508C21.773,3.539,24.844,1.524,29.039,0z"></path>
            ...
            <div class="quote-default__text">
              <p class="q">It’s great that there are such templates that are available to both professional and beginner web developers
                at affordable price. The job you did with this template is surely appreciated!</p>
            </div>
            <p class="quote-default__cite">Tiberio Bedas</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row no-gutters">
      <div class="col-lg-6 cat-wrap bg-accent">
        <div class="cat-mod-1">
          ...
          <p>its help you can quickly build custom HTML websites of any
            kind, and use our VIDE technology to accelerate your development and reduce QA time. It will provide you with
            lots of advantages.</p>
          <a class="button button-gray-light-outline" href="#">Saiba Mais</a>
        </div>
      </div>
      <div class="col-lg-6 bg-image bg-image-3 cat-wrap">
        <div class="cat-mod-1">
          <h3>Você bem Pop</h3>
          <p>You will be completely happy with our products and services. If not, we are ready to offer 100% money back during
            30 days from the purchase date. No questions asked. </p>
          <a class="button button-primary" href="#">Saiba Mais</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-lg bg-default">
    <div class="container">
      <!-- Owl Carousel-->
      <div class="owl-carousel text-center" data-items="1" data-sm-items="2" data-md-items="4" data-lg-items="5" data-xl-items="6"
        data-stage-padding="15" data-loop="true" data-margin="30" data-mouse-drag="false" data-dots="true">
        <div class="item">
          <a class="link-transparent" href="#">
            <img src="images/brand-1-128x111.png" alt="" width="128" height="111" />
          </a>
        </div>
        <div class="item">
          <a class="link-transparent" href="#">
            <img src="images/brand-2-129x102.png" alt="" width="129" height="102" />
          </a>
        </div>
        <div class="item">
          <a class="link-transparent" href="#">
            <img src="images/brand-3-143x110.png" alt="" width="143" height="110" />
          </a>
        </div>
        <div class="item">
          <a class="link-transparent" href="#">
            <img src="images/brand-4-129x86.png" alt="" width="129" height="86" />
          </a>
        </div>
        <div class="item">
          <a class="link-transparent" href="#">
            <img src="images/brand-5-142x102.png" alt="" width="142" height="102" />
          </a>
        </div>
        <div class="item">
          <a class="link-transparent" href="#">
            <img src="images/brand-6-134x122.png" alt="" width="134" height="122" />
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-sm-center justify-content-lg-start row-30 row-md-60">
        <div class="col-sm-10 col-md-6 col-lg-10 col-xl-3">
          <h6>Sobre</h6>
          <p>Futuro financeiro é um assistente virtual pra performar sua vida financeira
            tools and features that make customization process much easier. A pack of child themes, specially designed for
            various business niches, allows users to create a fully functional site for any specific business quickly and
            worry-free.
          </p>
        </div>
            ...
            <li>
              ...
              <article class="comment-minimal">
                ...
                <p class="comment-minimal__link">
                  <a href="standard-post.html">Site Speed and Search Engines Optimization Aspects</a>
                </p>
              </article>
            </li>
            <li>
              ...
              <article class="comment-minimal">
                <p class="comment-minimal__author">Brian Williamson on</p>
                <p class="comment-minimal__link">
                  <a href="standard-post.html">5 Things to Know Before You Buy an HTML Template</a>
                </p>
              </article>
            </li>
            <li>
              ...
              <article class="comment-minimal">
                <p class="comment-minimal__author">Brian Williamson on</p>
                <p class="comment-minimal__link">
                  <a href="standard-post.html">Turning Your Site into a Sales Machine</a>
                </p>
              </article>
            </li>
          </ul>
    ...
    <div class="container">
      <div class="footer-corporate__inner">
        ...
        <ul class="list-inline-xxs">
          ...
          <li>
            <a class="icon icon-xxs icon-primary fa fa-pinterest" href="#"></a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog_custom">
      ...
      <div class="modal-dialog__inner">
        ...
        <div class="modal-dialog__content">
          <h5>Register Form</h5>
          <!-- RD Mailform-->
          <form class="rd-mailform rd-mailform_responsive" data-form-output="form-output-global" data-form-type="contact" method="post"
...
<script>
  ...
  new Chart(document.getElementById("doughnut-chart"), {
    type: 'doughnut',
    data: {
      labels: ["Meus gastos", "Heloisa", "Mariana", "Fernanda"],
      datasets: [
        {
          label: "Population (millions)",
          backgroundColor: ["#16a326", "#35c445","#42f456","#41db52"],
          data: [4000,1100,734,433]
        }
      ]
    },
    options: {
...
<script type="text/javascript" src="original/sdk">
