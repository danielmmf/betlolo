    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                if (toState.data && toState.data.pageTitle) title = 'WeGet2U | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
...
function iboxTools($timeout) {
    return {
        restrict: 'A',
        scope: true,
        templateUrl:  appPath + 'views/common/ibox_tools.html',
...
function iboxToolsFullScreen($timeout) {
    return {
        restrict: 'A',
        scope: true,
        templateUrl:  appPath + 'views/common/ibox_tools_full_screen.html',
        controller: function ($scope, $element) {
            // Function for collapse ibox
            $scope.showhide = function () {
                var ibox = $element.closest('div.ibox');
